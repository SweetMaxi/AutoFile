...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='https://t.me/AnimeToon_Hindi')
            ]
            ]
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    caption=f_caption,
                    reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("⚡ Join Main Channel ⚡", url="https://t.me/AnimeToon_Hindi") ] ] ),
    ...
    if not files_:
        ...
        try:
            ...
            if CUSTOM_FILE_CAPTION:
                try:
                    f_caption=CUSTOM_FILE_CAPTION.format(previouscaption= '' if title is None else title, file_size='' if size is None else size, file_caption='')
    ...
    if CUSTOM_FILE_CAPTION:
        try:
            f_caption=CUSTOM_FILE_CAPTION.format(previouscaption= '' if title is None else title, file_size='' if size is None else size, file_caption='' if f_caption is None else f_caption)
        except Exception as e:
            logger.exception(e)
            f_caption=f_caption
    if f_caption is None:
